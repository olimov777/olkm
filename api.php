...
//settings @php_bot_kodlari
$fontSize = 130;
$backgroundPath = "photo.jpg";
$font = "font/font.ttf";
$text = $_GET['text'];
$padding = 5; //from edges
...
for($i = 0; $i < count($textRows); $i++)
{
    ...
    imagettfstroketext($im, $fontSize, 0, $position_center, $position_middle+160, $colorBlack, $colorGrey, $font, $textRows[$i], 2);
}
imagejpeg($im, "img/goto16.jpg");
header ('location: img/goto16.jpg');
}
